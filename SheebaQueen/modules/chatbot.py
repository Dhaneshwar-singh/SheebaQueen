...
# This file is part of SheebaQueen (Telegram Bot)
...
async def hmm(client, message):
    ...
    if chat_id in en_chats:
        ...
        response = response.replace("Aco", "Sheeba")
        response = response.replace("aco", "Sheeba")
        ...
        response = response.replace("Aco", "Sheeba")
        response = response.replace("aco", "Sheeba")
        response = response.replace("Luna", "Sheeba")
        response = response.replace("luna", "Sheeba")
        pro = response
        if not "en" in lan and not lan == "":
            try:
...
<b> Chatbot </b>
 - /ask [question]: Ask question from Sheeba
